    ...
    inquirer.prompt([
        {
            ...
            if (answer.addEmployees === "Add an Engineer?") {
                ...
                const html = generateHtml(
                    globalAnswers.manager.teamManager,
                    globalAnswers.manager.managerEmployeeId,
                    globalAnswers.manager.managerEmailAddress,
                    globalAnswers.manager.managerOfficeNumber,
                    globalAnswers.interns,
                    globalAnswers.engineers
                )
                writeToFile(html)
...
function addIntern() {
 ...
 function generateHtml(
    ...
    const body = teamManager;
    const bodyTwo = managerEmployeeId;
    const bodyThree = managerEmailAddress;
    const bodyFour = managerOfficeNumber;
    const bodyFive = interns.map((intern) => {
        return `
    ...
    const bodySix = engineers.map((engineer) => {
        return `
